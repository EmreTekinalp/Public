...
@brief: Some conveninience functions for working with PySide and maya
...
def load_ui_type(ui_file):
    ...
    to py code in-memory first and then execute it in a special frame to retrieve
    the form_class.
...
def toQtControl(mayaName):
    """Convert to QWidget from control."""
...
def toQtObject(mayaName):
    """Convert to QtObject from maya ui."""
    ptr = OpenMayaUI.MQtUtil.findControl( mayaName )
    if ptr is None:
