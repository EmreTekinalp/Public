...
#include "deformertemplate.h"

MTypeId DeformerTemplate::id(0x1233567);
MObject DeformerTemplate::a_in_curve;
MObject DeformerTemplate::a_cvs;
MObject DeformerTemplate::a_degree;

DeformerTemplate::DeformerTemplate() {
}

DeformerTemplate::~DeformerTemplate() {
}

void* DeformerTemplate::creator() {
  return new DeformerTemplate();
}

MStatus DeformerTemplate::initialize() {
...
MStatus DeformerTemplate::deform(MDataBlock& block, MItGeometry& iter,
