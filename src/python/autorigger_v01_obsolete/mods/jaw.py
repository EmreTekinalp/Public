...
@brief: Jaw module with different jaw classes
'''
...
class BipedJawGuide(mod.MasterMod):
    """
    This class creates a biped jaw guide system based on the specifications 
    ...
    def __init__(self,
        ...
        super(BipedJawGuide, self).__init__()
...
#end class BipedJawGuide()


class QuadrupedJawGuide(mod.MasterMod):
    """
    This class creates a quadruped jaw guide system based on the specifications 
    defined in the AutoRigger Interface (Properties and Navigator).
    """
    ...
    def __init__(self,
        ...
        ########################################################################
        #superclass inheritance initialisation
        super(QuadrupedJawGuide, self).__init__()
    ...
    def __jaw_cleanup(self):
        ...
        attr = attribute.Attribute()
        attr.lockAll(node = self.gd.g_grp)        
        attr.lockAttr(node = self.gd.g_ctl, attribute = ['tx'])
        attr.lockAttr(node = self.gd.g_ctl[-1], attribute = ['r'])
        attr.lockAttr(node = self.gd.g_ctl[0], attribute = ['ry','rz'])        
        attr.lockAttr(node = self.gd.g_ctl, attribute = ['s', 'v'])
    #end def __jaw_cleanup()
